...
class utilizationApp():
	...
	def __init__(self, drive, logmanager, dates=None, total_time=None, label_description=None, drop=None, create=None):
		self.dates = dates
	...
	def drop_table(self):
		...
		self.logmanager.logged('Table was dropped!')
	...
	def create_table(self):
		...
		self.logmanager.logged('Table was created!')
	...
	def insert_data(self):
		...
		self.logmanager.logged('Data was inserted!')
		self.logmanager.logged(''' INSERT INTO {}(Dates, total_time, label_description)
						VALUES({}, {}, {})'''.format(self.table, self.dates, self.total_time, self.description))
	...
	def delete_data(self, remove):
		...
		self.logmanager.logged('Data was removed!')
		self.logmanager.logged(sql)
	...
	def write_data_to_csv(self):
		...
		self.logmanager.logged('Data was written to csv!')
	...
	def backup_db(self):
		...
		self.logmanager.logged('Data was backed up!')


	def backup_files(self):
		bf.run_backup(self.metric_file, self.metric_backup_dir)

		self.logmanager.logged('Files were backedup!')
...
if __name__ == '__main__':
	...
	d = os.path.splitdrive(sys.executable)[0]

	logs = log.taskLogger('logs')

	utilApp = utilizationApp(d, logs, args.dates, args.time, args.desc, args.drop, args.create)
